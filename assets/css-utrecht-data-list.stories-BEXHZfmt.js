import{j as e}from"./jsx-runtime-BlAj40OV.js";import{D as h,a as k,b,c as _,d as w}from"./index.esm-Bd5EsrpD.js";import"./index-Cs7sjTYM.js";import"./_commonjsHelpers-BosuxZz1.js";import"./objectDestructuringEmpty-91S45k9y.js";import"./extends-CF3RwP-h.js";const j=`<!-- @license CC0-1.0 -->
...
`,A=({appearance:m,items:v})=>e.jsx(h,{appearance:m,children:v.map(({key:c,keyId:u,value:g,actions:a,multiline:p})=>e.jsxs(k,{children:[e.jsx(b,{id:u,children:c}),e.jsx(_,{multiline:p,children:g}),a&&e.jsx(w,{children:a})]}))}),W={title:"CSS Component/Data list",id:"css-data-list",component:A,argTypes:{appearance:{description:"Appearance",options:["","rows"],control:{type:"select"}}},args:{appearance:"",items:[]},parameters:{tokensPrefix:"utrecht-data-list",status:{type:"WORK IN PROGRESS"},docs:{description:{component:j}}}},n={args:{appearance:"rows",items:[{key:"Voornaam",value:"John"},{key:"Achternaam",value:"Doe"},{key:"Adres",value:`Stadhuisplein 130
5038 TC Tilburg`,multiline:!0}]},parameters:{docs:{description:{story:"Styling via `utrecht-data-list` class name."}}}},t=W;var i,o,r;n.parameters={...n.parameters,docs:{...(i=n.parameters)==null?void 0:i.docs,source:{originalSource:`{
  args: {
    appearance: 'rows',
    items: [{
      key: 'Voornaam',
...
}`,...(r=(o=n.parameters)==null?void 0:o.docs)==null?void 0:r.source}}};var s,d,l;t.parameters={...t.parameters,docs:{...(s=t.parameters)==null?void 0:s.docs,source:{originalSource:"meta",...(l=(d=t.parameters)==null?void 0:d.docs)==null?void 0:l.source}}};const D=["Default","DesignTokens"];export{n as Default,t as DesignTokens,D as __namedExportsOrder,W as default};
