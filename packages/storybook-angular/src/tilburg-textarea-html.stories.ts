...
import { bugs, descriptionHtml, examples } from '../../storybook-shared/src/tilburg-textarea.examples';

/* Thin Angular wrapper around the shared HTML/CSS reference markup
   (`packages/storybook-shared/src/tilburg-textarea.examples.ts`). The React
   storybook's `tilburg-textarea.stories.tsx` consumes the same source. */
