...
export const Visible: Story = {
  ...
  render: () => (
    <div className="tilburg-loading-spinner__overlay" aria-busy="true" aria-label="Bezig met laden">
      <div className="tilburg-loading-spinner__panel">
        <div className="tilburg-loading-spinner__content">
          <span className="tilburg-loading-spinner__title">Bezig met laden</span>
          <div role="status">
            <Spinner />
          </div>
          <span className="tilburg-loading-spinner__message">Een momentje alstublieft...</span>
        </div>
      </div>
    </div>
  ),
...
export const SpinnerOnly: Story = {
  ...
  render: () => (
    <div role="status" style={{ display: 'inline-block' }}>
      <Spinner />
    </div>
  ),
};
