...
import { TilburgWbcTable } from '@gemeente-tilburg/web-components-react';
import type { Meta, StoryObj } from '@storybook/react';
import { bugs, descriptionWebComponents } from '../../storybook-shared/src/tilburg-table.examples';

/* Stencil `<tilburg-wbc-table>` rendered through its generated React proxy.
...
const meta = {
  ...
  id: 'tilburg-table-wbc',
  component: TilburgWbcTable,
  tags: ['autodocs'],
  parameters: {
    bugs,
    docs: { description: { component: descriptionWebComponents } },
  },
} satisfies Meta<typeof TilburgWbcTable>;
  ...
  render: () => (
    <div style={{ display: 'flex', flexDirection: 'column', gap: '2rem' }}>
      <div>
        ...
        <TilburgWbcTable caption="Inwoners van Tilburg">
          <table>
            <thead>
              <tr>
