...
import { bugs, descriptionHtml, examples } from '../../storybook-shared/src/tilburg-page.examples';

/* Thin React wrapper around the shared HTML/CSS reference markup
   (`packages/storybook-shared/src/tilburg-page.examples.ts`). The Angular
   storybook's `tilburg-page-html.stories.ts` consumes the same source. */

const meta = {
  title: 'Tilburg HTML/Page',
  id: 'tilburg-page',
  tags: ['autodocs'],
  parameters: {
    layout: 'fullscreen',
