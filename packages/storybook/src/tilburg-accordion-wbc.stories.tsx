...
import { TilburgWbcAccordion, TilburgWbcAccordionSection } from '@gemeente-tilburg/web-components-react';
...
const meta = {
  ...
  id: 'tilburg-accordion-wbc',
  component: TilburgWbcAccordion,
  tags: ['autodocs'],
  parameters: {
    bugs,
    docs: { description: { component: descriptionWebComponents } },
  },
} satisfies Meta<typeof TilburgWbcAccordion>;
...
const MultiOpenDemo = ({ initialOpenIds = [], sections }: { initialOpenIds?: string[]; sections: SectionSpec[] }) => {
  ...
  return (
    <TilburgWbcAccordion aria-label="Veelgestelde vragen">
      {sections.map((section) => (
        <TilburgWbcAccordionSection
          key={section.id}
  ...
  render: () => (
    <div style={{ display: 'flex', flexDirection: 'column', gap: '2rem' }}>
      ...
      <div>
        ...
        <TilburgWbcAccordion>
          <TilburgWbcAccordionSection sectionKey="a1" label="Eerste" autoToggle>
            <p className="utrecht-paragraph">Klik om te wisselen.</p>
          </TilburgWbcAccordionSection>
          <TilburgWbcAccordionSection sectionKey="a2" label="Tweede" autoToggle>
      ...
      <div>
        ...
        <TilburgWbcAccordion displayName="Veelgestelde vragen" headingLevel={2}>
          <TilburgWbcAccordionSection sectionKey="d1" label="Vraag 1" autoToggle>
            <p className="utrecht-paragraph">Antwoord 1.</p>
          </TilburgWbcAccordionSection>
          <TilburgWbcAccordionSection sectionKey="d2" label="Vraag 2" autoToggle>
...
export const AutoToggle: Story = {
  name: 'Auto-toggle',
  render: () => (
    <TilburgWbcAccordion displayName="Veelgestelde vragen">
      {SAMPLE.map((section) => (
        <TilburgWbcAccordionSection key={section.id} sectionKey={`auto-${section.id}`} label={section.label} autoToggle>
          {section.body}
        </TilburgWbcAccordionSection>
      ))}
    </TilburgWbcAccordion>
