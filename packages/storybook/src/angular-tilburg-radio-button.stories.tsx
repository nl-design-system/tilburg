...
import readme from './angular-tilburg-radio-button.md?raw';

const meta = {
  title: 'Tilburg Angular Components/Radio Button',
  id: 'angular-tilburg-radio-button',
  component: Button,
  argTypes: {
    children: {
      name: 'Content',
  ...
  tags: ['autodocs'],
  parameters: {
    bugs: 'https://github.com/nl-design-system/tilburg/labels/component%2Fradio%2Fbutton',
    design: {
      type: 'figma',
