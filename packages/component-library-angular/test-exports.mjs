...
const getAbsoluteSubset = (base, pkg) =>
  cloneDeepWith(getSubset(pkg), (value) =>
    typeof value === "string" ? resolve(base, value) : undefined,
  );
...
const getAbsolutePaths = (base, pkg) =>
  getPaths(pkg).map((path) => resolve(base, path));
